//const scoreLa = document.querySelector('#scoreLa')
                            ...
                            if (invaderFound && projectileFound){
                               ...
                               createParticles({
                                ...
                                if (grid.invaders.length > 0)  {
                                    ...
                                    invaders.length - 1]
                                    grid.width = lastInvader.position.x - firstInvader.
                                    position.x + lastInvader.width
